...
--Violation of PRIMARY KEY constraint 'PK_Emp_3214EC07AD9C33E7'. 
...
insert into Emp values (1,'Ravi','9876543210','rav1256@yahoo.com')
--Violation of PRIMARY KEY constraint 'PK__Emp__3214EC0789F538D7'.
-- Cannot insert duplicate key in object 'dbo.Emp'. The duplicate key value is (1).
...
insert into Students (SName,SFee) values ('Riya',4579.50)
-------------------------------------------------------------
...
insert into Product values ('Nothing-3a',2000,4)

insert into Product values ('Shirt',200,2)
insert into Product values ('T-Shirt',199,2)
insert into Product values ('T-Shirt',399,2)
select * from Product
...
select * from Product join Category on 
Product.ProductCategory=Category.CatId
-- or
...
p.ProductCategory 'Product Category',c.CategoryName 'Category Name'
